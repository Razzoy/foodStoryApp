...
export function PhotoCard({test, imageUrls,handleAdd,handleRemoveImage}:PhotocardProps) {
  ...
  return (
    <div>
      ...
      {imageUrls.length > 0 && imageUrls?.map((imageUrl,index) => {
        ...
        return (
          <div key={imageUrl} className="flex justify-center relative flex-col items-center  ">
          {/* Display the selected image */}
          ...
          <button className=" flex justify-center cursor-pointer border-2  bg-white hover:bg-transparent  hover:border-2 hover:bg-gray-200 text-gray-400 hover:text-white font-Nunito font-semibold text-2xl px-[8px] rounded-lg" onClick={()=>handleRemoveImage(index)}>x</button>
          <div className="flex">
            <label htmlFor={test}>
